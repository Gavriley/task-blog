...
ActiveRecord::Schema.define(version: 20161026083152) do
  ...
  add_index "categories_posts", [nil, nil], name: "index_categories_posts_on_category_and_post"

  create_table "comments", force: :cascade do |t|
    t.string   "content",    limit: 600, default: "", null: false
    t.integer  "user_id"
    t.integer  "post_id"
